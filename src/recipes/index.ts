...
export const recipes: Record<string, Recipe> = {
  ...
  agency: {
    ...
    theme: {
      ...
      // Header: dark glassmorphism with gradient CTA - bold, edgy, no border
  ...
  startup: {
    ...
    theme: {
      ...
      // Header: dark glassmorphism with subtle CTA - minimal, tech-focused
      '--header-bg': 'rgba(9, 9, 11, 0.8)',
      '--header-text': '#a1a1aa',
      '--header-border': 'rgba(39, 39, 42, 0.5)',
      '--header-height': '64px',
      '--header-cta-bg': 'rgba(99, 102, 241, 0.1)',
      '--header-cta-text': '#a5b4fc',
      '--header-cta-hover-bg': 'rgba(99, 102, 241, 0.2)',
      '--header-cta-padding': '0.5rem 1rem',
      '--header-cta-radius': '8px',
      '--header-cta-font-size': '0.8125rem',
      '--header-cta-font-weight': '500',
      // Logo styling
    ...
    fonts: {
      google: 'https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700&display=swap',
    },
    logo: {
  ...
  'product-launch': {
    ...
    fonts: {
      google: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Fraunces:wght@400;500;600;700&display=swap',
    },
    logo: {
  ...
  'app-download': {
    ...
    theme: {
      ...
      '--header-border': 'transparent',
      '--header-height': '66px',
      '--header-cta-bg': 'linear-gradient(135deg, #7c3aed, #a855f7)',
      '--header-cta-text': '#ffffff',
      '--header-cta-hover-bg': 'linear-gradient(135deg, #6d28d9, #9333ea)',
      '--header-cta-padding': '0.75rem 1.5rem',
    ...
    fonts: {
      google: 'https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap',
    },
    logo: {
  ...
  newsletter: {
    ...
    theme: {
      ...
      // Header: warm light with green CTA
      ...
      // Footer: light warm background
      '--footer-bg': '#faf8f5',
      '--footer-text': '#78716c',
      '--footer-heading': '#1c1917',
      '--footer-link': '#78716c',
      '--footer-link-hover': '#059669',
    },
    fonts: {
      google: 'https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Libre+Baskerville:wght@400;700&display=swap',
    },
    logo: {
